...
- Нажми F5 или Run → Run Module или прямо в терминале ```python turtle_game.py```
- Управляй оранжевой черепашкой стрелками или клавишами Vim - h, j, k, l
- Собирай зелёные кристаллы (3 для победы). Число можно поменять в константах.
- Убегай от красных ботов!
...
## 🪗 Код игры с docstrings, typehinting и полным соблюдением PEP8 -> turtle_game.py
